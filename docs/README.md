...
flowchart LR
    ...
    LT["💼 Technical"]
    T1["৪০%<br/>Architecture"]
    T2["৩০%<br/>Backend + AI"]
    T3["৪০%<br/>Fork সিদ্ধান্ত"]
    T4["৪০%<br/>আন্তর্জাতিক বাজার"]
    T5["২০%<br/>ক্ষয় রোধ"]
    T6["৩০%<br/>মালিকানার বাজি"]
    T7["১৫%<br/>স্তর অটুট"]
    T8["১৫%<br/>প্রাসঙ্গিকতা"]
    T9["২০%<br/>হস্তান্তর শুরু"]
    T10["৩০%<br/>স্থায়ী কিছু"]
    LT ~~~ T1 ~~~ T2 ~~~ T3 ~~~ T4 ~~~ T5 ~~~ T6 ~~~ T7 ~~~ T8 ~~~ T9 ~~~ T10

    LF["💰 Financial"]
    F1["৩০%<br/>বীমা · EF ৩ মাস"]
    F2["৪০%<br/>EF ৬ মাস"]
    F3["৩০%<br/>Net Worth শুরু"]
    F4["৩০%<br/>NW ২×"]
    F5["৪০%<br/>NW ৫× · FI সংখ্যা"]
    F6["২৫%<br/>NW ৮× · ঝুঁকির সীমা"]
    F7["২৫%<br/>NW ১২×"]
    F8["৩৫%<br/>FI ছোঁয়া · উইল"]
    F9["২৫%<br/>শিক্ষা-খরচ"]
    ...
    LH["🩺 Health"]
    H1["২০%<br/>Baseline · শুরু"]
    H2["১০%<br/>২৪ মাস অটুট"]
    H3["১০%<br/>ঘুম ও চাপ"]
    H4["১০%<br/>ঘুম অলঙ্ঘনীয়"]
    H5["১৫%<br/>শক্তি ও গতিশীলতা"]
    H6["১৫%<br/>৪০-এর screening"]
    H7["২৫%<br/>সব বা কিছুই না"]
    H8["২০%<br/>স্ত্রীরও স্বাস্থ্য"]
    H9["২০%<br/>৪৫-এর screening"]
    H10["২৫%<br/>দীর্ঘায়ুই legacy"]
    LH ~~~ H1 ~~~ H2 ~~~ H3 ~~~ H4 ~~~ H5 ~~~ H6 ~~~ H7 ~~~ H8 ~~~ H9 ~~~ H10

    classDef headLbl fill:#0f172a,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    classDef head fill:#1e293b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    classDef techLbl fill:#1e3a8a,stroke:#3b82f6,stroke-width:3px,color:#ffffff
    classDef tech fill:#2563eb,stroke:#1d4ed8,color:#ffffff
    classDef finLbl fill:#14532d,stroke:#22c55e,stroke-width:3px,color:#ffffff
    classDef fin fill:#16a34a,stroke:#15803d,color:#ffffff
    classDef famLbl fill:#581c87,stroke:#a855f7,stroke-width:3px,color:#ffffff
    classDef fam fill:#9333ea,stroke:#7e22ce,color:#ffffff
    classDef healthLbl fill:#7f1d1d,stroke:#ef4444,stroke-width:3px,color:#ffffff
    classDef health fill:#dc2626,stroke:#b91c1c,color:#ffffff
    class LA headLbl
    class A1,A2,A3,A4,A5,A6,A7,A8,A9,A10 head
    class LT techLbl
    class T1,T2,T3,T4,T5,T6,T7,T8,T9,T10 tech
    class LF finLbl
    class F1,F2,F3,F4,F5,F6,F7,F8,F9,F10 fin
    class LM famLbl
    class M1,M2,M3,M4,M5,M6,M7,M8,M9,M10 fam
    class LH healthLbl
    class H1,H2,H3,H4,H5,H6,H7,H8,H9,H10 health
```
