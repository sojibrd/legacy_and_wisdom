...
> সময়সীমা: **১৮ মাস** · শেষ হালনাগাদ: ২০২৬-০৮-৩১
...
| ক্ষেত্র | **Frontend** (নির্দিষ্ট framework — ⏳ নিশ্চিত করা বাকি) |
...
- Coverage: **বার্ষিক আয়ের ১০–১২ গুণ**
...
- [ ] ৩টা কোম্পানি থেকে Term Life quote সংগ্রহ (coverage: বার্ষিক আয়ের ১০–১২ গুণ)
...
- [ ] Architecture learning path চূড়ান্ত (⏳ framework নিশ্চিত হওয়ার পর)
...
- [ ] *(framework React না হলে)* React-এ একই architecture ধারণা প্রকাশ করা শেখা — ~৪০ ঘণ্টা
...
**Shariah preference থাকলে:** কাঠামো অপরিবর্তিত — সঞ্চয়পত্রের জায়গায় **ইজারা সুকুক**, DPS-এর জায়গায় **Mudaraba DPS**, mutual fund-এর জায়গায় **Shariah fund**।

---

## ⏳ অমীমাংসিত

- [ ] **দৈনন্দিন framework কী?** (React / Ember / অন্য) — Ember হলে Phase 3-এ ~৪০ ঘণ্টা আলাদা রাখতে হবে React-এ ধারণা অনুবাদের জন্য, কারণ বাজার React-প্রধান
- [ ] **Shariah-সম্মত instrument দরকার কি না?** — দরকার হলে instrument বদলাবে, কাঠামো নয়
...
```mermaid
flowchart LR
    S(["Stage 1 · Foundation<br/>১৮ মাস"])

    S --> PH["⏱️ Phase"]
    P0["মাস ১-৩<br/>Quick Wins"]
    P1["মাস ৪-১২<br/>Deep Work"]
    P2["মাস ১৩-১৮<br/>Prove ও Position"]
    PH --> P0 --> P1 --> P2

    S --> G0["💼 Technical · ৪০%"]
    G0 --> G00["১ · Domain depth<br/>২টা feature lead"]
    G0 --> G01["২ · System Design<br/>৫টা doc"]
    G0 --> G02["৩ · Visible artifact<br/>৩টা"]
    G0 --> G03["৪ · বাজার যাচাই<br/>১টা interview"]
    G0 --> G04["শিখব Architecture<br/>প্রমাণ Performance দিয়ে"]

    S --> G1["💰 Financial · ৩০%"]
    G1 --> G10["৫ · Emergency Fund<br/>৩ মাস"]
    G1 --> G11["৬ · Term Life ও<br/>Health coverage"]
    G1 --> G12["৭ · ১২ মাস tracking"]
    G1 --> G13["ক্রম · বীমা → Buffer<br/>→ EF → বিনিয়োগ"]

    S --> G2["🩺 Health · ২০%"]
    G2 --> G20["৮ · Baseline metrics<br/>ও চিকিৎসা শুরু"]
    G2 --> G21["৯ · সপ্তাহে ৩ দিন<br/>টানা ৬ মাস"]

    S --> G3["👨‍👩‍👧 Family · ১০%"]
    G3 --> G30["১০ · স্ত্রীর সাথে<br/>সাপ্তাহিক sync"]

    S --> G4["🎯 Stretch"]
    G4 --> G40["৪০% compensation বৃদ্ধি"]

    S --> G5["🔥 প্রথম ৬ সপ্তাহ"]
    G5 --> G50["Term Life Insurance"]
    G5 --> G51["৩০ দিন খরচ tracking"]
    G5 --> G52["Full body checkup"]
    ...
    class G1,G10,G11,G12,G13 fin
    class G2,G20,G21 health
    class G3,G30 fam
    class G4,G40 stretch
    class G5,G50,G51,G52 urgent
```
